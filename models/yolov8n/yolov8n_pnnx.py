...
class Model(nn.Module):
    ...
    def forward(self, v_0):
        ...
        v_137 = v_136.reshape(1, 64, 6400)
        v_138 = self.model_22_cv2_1_0_conv(v_116)
        v_139 = self.pnnx_unique_48(v_138)
        v_140 = self.model_22_cv2_1_1_conv(v_139)
        v_141 = self.pnnx_unique_49(v_140)
        v_142 = self.model_22_cv2_1_2(v_141)
        v_143 = v_142.reshape(1, 64, 1600)
        v_144 = self.model_22_cv2_2_0_conv(v_130)
        v_145 = self.pnnx_unique_50(v_144)
        v_146 = self.model_22_cv2_2_1_conv(v_145)
        v_147 = self.pnnx_unique_51(v_146)
        v_148 = self.model_22_cv2_2_2(v_147)
        v_149 = v_148.reshape(1, 64, 400)
        v_150 = torch.cat((v_137, v_143, v_149), dim=-1)
        v_151 = self.model_22_cv3_0_0_conv(v_102)
        v_152 = self.pnnx_unique_52(v_151)
        v_153 = self.model_22_cv3_0_1_conv(v_152)
        v_154 = self.pnnx_unique_53(v_153)
        v_155 = self.model_22_cv3_0_2(v_154)
        v_156 = v_155.reshape(1, 80, 6400)
        v_157 = self.model_22_cv3_1_0_conv(v_116)
        v_158 = self.pnnx_unique_54(v_157)
        v_159 = self.model_22_cv3_1_1_conv(v_158)
        v_160 = self.pnnx_unique_55(v_159)
        v_161 = self.model_22_cv3_1_2(v_160)
        v_162 = v_161.reshape(1, 80, 1600)
        v_163 = self.model_22_cv3_2_0_conv(v_130)
        v_164 = self.pnnx_unique_56(v_163)
        v_165 = self.model_22_cv3_2_1_conv(v_164)
        v_166 = self.pnnx_unique_57(v_165)
        v_167 = self.model_22_cv3_2_2(v_166)
        v_168 = v_167.reshape(1, 80, 400)
        v_169 = torch.cat((v_156, v_162, v_168), dim=-1)
        v_170 = v_150.reshape(1, 4, 16, 8400)
        v_171 = torch.transpose(v_170, dim0=2, dim1=1)
        v_172 = F.softmax(v_171, dim=1)
        v_173 = self.model_22_dfl_conv(v_172)
        v_174 = v_173.reshape(1, 4, 8400)
        v_175 = self.pnnx_fold_anchor_points_1_data
        v_176, v_177 = torch.chunk(v_174, chunks=2, dim=1)
        v_178 = (v_175 - v_176)
        v_179 = (v_175 + v_177)
        v_180 = ((v_178 + v_179) / 2)
        v_181 = (v_179 - v_178)
        v_182 = torch.cat((v_180, v_181), dim=1)
        v_183 = (v_182 * v_131)
        v_184 = F.sigmoid(v_169)
        v_185 = torch.cat((v_183, v_184), dim=1)
        return v_185
...
def export_onnx():
    ...
    torch.onnx.export(net, v_0, "yolov8n_pnnx.py.onnx", export_params=True, operator_export_type=torch.onnx.OperatorExportTypes.ONNX_ATEN_FALLBACK, opset_version=13, input_names=['in0'], output_names=['out0'])
...
def export_pnnx():
    ...
    import pnnx
    pnnx.export(net, "yolov8n_pnnx.py.pt", v_0)
