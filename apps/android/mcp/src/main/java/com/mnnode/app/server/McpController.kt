...
class McpController(
    ...
    suspend fun get(call: ApplicationCall) {
        call.response.header("MCP-Protocol-Version", ProtocolVersion)
        call.respondText(
            error(null, -32000, "Lociant MCP endpoint supports Streamable HTTP POST. SSE GET is not enabled.").toString(),
            JsonContentType,
        ...
        for (index in 0 until tools.length()) {
            ...
            output.put(JSONObject()
                ...
                .put("annotations", JSONObject()
                    ...
                    .put("openWorldHint", policy.optBoolean("remoteAllowed", false))))
        }
        return output
    }
